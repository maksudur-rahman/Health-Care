...
public class BMIActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLinearLayout = (LinearLayout) findViewById(R.id.bottom_details_linear_layout);
        setUpLinearOutline();

        mPoundInchesButton = (Button) findViewById(R.id.bmi_pound_inches_button);
        mPoundInchesButton.setOnClickListener(this);

        mKgMetersButton = (Button) findViewById(R.id.bmi_kg_meters_button);
        mKgMetersButton.setOnClickListener(this);

        mResultTextView = (TextView) findViewById(R.id.result_text_view);

        mPoundEditText = (EditText) findViewById(R.id.weight_in_pound_edit_text);
        mInchesEditText = (EditText) findViewById(R.id.height_in_inches_edit_text);
        mKilogramEditText = (EditText) findViewById(R.id.weight_in_kg_edit_text);
        mMetersEditText = (EditText) findViewById(R.id.height_in_meters_edit_text);

        mCalculateButton = (Button) findViewById(R.id.show_result_button);
